...
Source0  : https://files.pythonhosted.org/packages/18/4d/8d522136c37d9e1ea74062b41b8d5e1318ebf45063ae46ce72ed60af223b/lark-parser-0.8.5.tar.gz
...
%prep
%setup -q -n lark-parser-0.8.5
cd %{_builddir}/lark-parser-0.8.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1585679909
...
cp %{_builddir}/lark-parser-0.8.5/LICENSE %{buildroot}/usr/share/package-licenses/lark-parser/af7225973c108376de2c312098b16c5a7a8828e6
