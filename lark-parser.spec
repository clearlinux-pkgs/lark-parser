...
Source0  : https://files.pythonhosted.org/packages/24/25/2047d9374e50ac3574cec1db21df2698b12deb4e1cea1cc62d89a77373f2/lark-parser-0.8.6.tar.gz
...
%prep
%setup -q -n lark-parser-0.8.6
cd %{_builddir}/lark-parser-0.8.6
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1591909757
...
cp %{_builddir}/lark-parser-0.8.6/LICENSE %{buildroot}/usr/share/package-licenses/lark-parser/af7225973c108376de2c312098b16c5a7a8828e6
