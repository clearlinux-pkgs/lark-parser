...
Version  : 0.8.9
Release  : 23
URL      : https://files.pythonhosted.org/packages/77/b1/2eec2f43b6b9d56a190e48b8f80fc0d365b5870619d67bcdadd9fee67ef4/lark-parser-0.8.9.tar.gz
Source0  : https://files.pythonhosted.org/packages/77/b1/2eec2f43b6b9d56a190e48b8f80fc0d365b5870619d67bcdadd9fee67ef4/lark-parser-0.8.9.tar.gz
...
%prep
%setup -q -n lark-parser-0.8.9
cd %{_builddir}/lark-parser-0.8.9
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1592409399
...
cp %{_builddir}/lark-parser-0.8.9/LICENSE %{buildroot}/usr/share/package-licenses/lark-parser/af7225973c108376de2c312098b16c5a7a8828e6
