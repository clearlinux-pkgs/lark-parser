...
%prep
%setup -q -n lark-parser-0.11.2
cd %{_builddir}/lark-parser-0.11.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1613489946
...
cp %{_builddir}/lark-parser-0.11.2/LICENSE %{buildroot}/usr/share/package-licenses/lark-parser/af7225973c108376de2c312098b16c5a7a8828e6
